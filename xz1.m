...
U1=squeeze(U1(46:64,44,1:10,i));
V1=ncread(ncfile2,'VWIND');
V1=squeeze(V1(46:64,44,1:10,i));
WD1=ncread(ncfile,'QV');
WD1=squeeze(WD1(46:64,44,1:10,i));
...
hold on;
quiver(xx1,zz1,U1,V1,0.3,'color','k');%以矢量箭头的方式画图，10是调节箭头长度.
...
m_grid; 
title(['201801',sprintf('%02d',i)]);

%colormap(color11);
hc=colorbar; %色标
%set(gca,'clim',[0 0.1]);  %设定绘图要素的取值范围
...
%suptitle('20180102')
 print(gcf,'-dpng','-r200',['F:\graduate\毕业论文\数据\picture\预报第1天\20180101',sprintf('%02d',i)])%%！！！！！！改改改！！！！！！！！
end