...
m_grid; 
title(['Q&W-201801',sprintf('%02d',j)]);
colormap(color11);
hc=colorbar; %色标
...
%print(gcf,'-dpng','-r200',['F:\graduate\毕业论文\数据\picture\预报第1天\DAVEQ&W-201801',sprintf('%02d',j)]);%输出到文件夹下。
