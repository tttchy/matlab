...
uwind1(1:n,1:m,j)=(uwind2(1:n,1:m,j)+uwind3(1:n,1:m,j));  %%%AQ英语计算北京时的日平均，
vwind1(1:n,1:m,j)=(vwind2(1:n,1:m,j)+vwind3(1:n,1:m,j));  %%%AQ英语计算北京时的日平均，
...
print(gcf,'-dpng','-r200',['F:\graduate\毕业论文\数据\picture\预报第1天\DAVEuvlon-20180101']);%输出到文件夹下。
