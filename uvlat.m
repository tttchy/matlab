...
U1=squeeze(U1(51,36:56,1:m,i)); %读出的U1为19×10single的两维数组。
...
nlat=squeeze(latmodel1(51,36:56)); %将模式的经度读取出来，并存放在数组nlon中
nlat1=squeeze(latmodel2(51,36:56));
nz=1:m;
[xx,zz]=meshgrid(nlat,nz); %将经度和垂直方向的数据以格点的形式赋值给[xx,zz].
[xx1,zz1]=meshgrid(nlat1,nz);
xx=xx';  %xx'将得到xx的数组转置
xx1=xx1';
zz1=zz1';
zz=zz';
...
m_grid; 
title(['W-lat201801',sprintf('%02d',j)]);
...
print(gcf,'-dpng','-r200',['F:\graduate\毕业论文\数据\picture\预报第1天\DAVEuvlat-201801',sprintf('%02d',j)]);%输出到文件夹下。
